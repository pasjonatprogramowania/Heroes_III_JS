...
class ForgeFabrica {
    create(_isUpgraded, _tier) {
        ...
        if (_isUpgraded === false) {
            if (_tier === 1) {
                return new creature_1.default(Tarczownik, 2, 5, 8, 3, new range_1.default(1, 3), 1, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 2) {
                return new creature_1.default(Awanturnik, 5, 5, 16, 5, new range_1.default(2, 5), 1, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 3) {
                return new creature_1.default(Podpalacz, 10, 5, 22, 6, new range_1.default(5, 6), 1, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 4) {
                ...
                return new creature_1.default(Jugernaut, 17, 17, 160, 8, new range_1.default(35, 45), 1, new damageCalculatorDefault_1.default(), 1);
            }
        }
        else {
            if (_tier === 1) {
                return new creature_1.default(ElitarnyTarczownik, 3, 6, 8, 5, new range_1.default(2, 3), 1, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 2) {
                return new creature_1.default(Najemnik, 8, 6, 18, 6, new range_1.default(2, 6), 1, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 3) {
                return new creature_1.default(Piromaniak, 10, 7, 22, 8, new range_1.default(5, 6), 1, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 4) {
                return new creature_1.default(Wysysaczdusz, 9, 9, 25, 13, new range_1.default(6, 9), 1, new damageCalculatorDefault_1.default(100), 1);
            }
            else if (_tier === 5) {
                ...
                return new creature_1.default(PodniebnyRycerz, 15, 18, 120, 8, new range_1.default(20, 25), 1, new damageCalculatorDefault_1.default(20, 2), 1);
            }
            else if (_tier === 7) {
                return new creature_1.default(Niszczyciel, 25, 25, 240, 11, new range_1.default(35, 45), 1, new damageCalculatorDefault_1.default(), 1);
            }
        }
    }
    createdDefCreature() {
