...
class NecropolisFactory {
    create(_isUpgraded, _tier, _amount = 1) {
        ...
        if (_isUpgraded === false) {
            if (_tier === 1) {
                return new creature_1.default(Skeleton, 5, 4, 6, 4, new range_1.default(1, 3), _amount, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 2) {
                return new creature_1.default(WalkingDead, 5, 5, 15, 3, new range_1.default(2, 3), _amount, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 3) {
                return new regenerateLostHpAfterTournEnd_1.default(new creature_1.default(Wight, 7, 7, 18, 5, new range_1.default(3, 5), _amount, new damageCalculatorDefault_1.default(), 1));
            }
            else if (_tier === 4) {
                return new blockCreatureCounterAttack_1.default(new creature_1.default(Vampier, 10, 9, 30, 6, new range_1.default(5, 8), _amount, new damageCalculatorDefault_1.default(), 1));
            }
            else if (_tier === 5) {
                ...
                return new creature_1.default(BlackKnight, 16, 16, 120, 7, new range_1.default(15, 30), _amount, new damageCalculatorMultipleyDamage_1.default(20, 2), 1);
            }
            else if (_tier === 7) {
                return new creature_1.default(BoneDragon, 17, 15, 150, 9, new range_1.default(25, 30), _amount, new damageCalculatorDefault_1.default(), 1);
            }
        }
        else {
            if (_tier === 1) {
                return new creature_1.default(SkeletonWarrior, 6, 6, 6, 5, new range_1.default(1, 3), _amount, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 2) {
                return new creature_1.default(Zombie, 5, 5, 20, 4, new range_1.default(2, 3), _amount, new damageCalculatorDefault_1.default(), 1);
            }
            else if (_tier === 3) {
                return new regenerateLostHpAfterTournEnd_1.default(new creature_1.default(Wraith, 7, 7, 18, 7, new range_1.default(3, 5), _amount, new damageCalculatorDefault_1.default(), 1));
            }
            else if (_tier === 4) {
                return new creature_1.default(VampireLord, 10, 10, 40, 9, new range_1.default(5, 8), _amount, new damageCalculatorWithHealingAttacker_1.default(100), 1);
            }
            else if (_tier === 5) {
